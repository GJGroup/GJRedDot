 ...
 *  x:默认中心偏右12个坐标，以红点原点x坐标为基准，
 *  也就是说红点frame.origin.x距离tabBarButton中心点的横向坐标距离默认是12
 *  y:默认中心偏上16个坐标，以红点原点中心点的y坐标为基准，
 *  也就是说红点frame.center.y距离tabBarButton中心点的纵向坐标距离默认是16
 *  通过offset可以在这基础上偏移
